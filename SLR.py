...
nonterm_userdef = []
term_userdef = []
#Taking rules from users
for i in range(int(input("Give number of rules: "))):
    x = input()
    rules.append(x)

#E , T , F
for i in range(int(input("Give number of Non-Terminal Symbol: "))):
    x = input()
    nonterm_userdef.append(x)

#'id', '+', '*', '(', ')'
for i in range(int(input("Give number of Terminal Symbol: "))):
    x = input()
    term_userdef.append(x)
